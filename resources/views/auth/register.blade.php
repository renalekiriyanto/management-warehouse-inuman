                        ...
                        <div class="card bg-light border-0 rounded-3 mb-4">
                            <div class="card-body p-3.5 text-start">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold text-dark mb-1" style="font-size: 0.85rem;">Informasi Pendaftaran
                                        </h6>
                                        <ul class="mb-0 ps-3 text-muted small"
                                            style="line-height: 1.5; font-size: 0.78rem;">
                                            <li>Hanya akun Google dengan domain <strong
                                                    class="text-dark">@spxexpress.com</strong> yang diperbolehkan.</li>
                                            <li>Setelah sign-in, Anda akan diarahkan ke halaman melengkapi profil (Station
                                                &amp; Role).</li>
                                            <li>Aktivasi akun sepenuhnya bergantung pada persetujuan administrator sistem.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="small text-muted mb-0">
                                Already have an account? <a href="{{ route('login') }}"
                                    class="text-primary-sb text-decoration-none fw-bold"
                                    style="transition: color 0.2s;">Login</a>
                            </p>
                        </div>
